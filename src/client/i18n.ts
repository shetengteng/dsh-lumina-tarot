...
const ZH = {
  ...
  artAquaticWarning: 'Aquatic Tarot 由 Andreas Schröter 创作，授权为 CC BY-NC-SA 3.0，仅限个人非商业用途。商业使用请改用极简或经典韦特。',
  cardBack: '牌背图案',
  ...
  aboutUpdate: 'DSH 不会自动更新插件。GitHub 安装后在终端执行：',
  aboutUpdateHint: '执行完重启 dsh web。本地 add . 的开发链接改完源码后 pnpm build 再重启即可。',
  spread_single: '单张指引',
...
const EN: Record<keyof typeof ZH, string> = {
  ...
  artAquaticWarning: 'Aquatic Tarot is by Andreas Schröter, licensed CC BY-NC-SA 3.0 — personal non-commercial use only. For commercial use, switch to Minimal or Classic Waite.',
  cardBack: 'Card back',
  ...
  aboutUpdate: 'DSH does not auto-update plugins. After a GitHub install, run this in a terminal:',
  aboutUpdateHint: 'Then restart dsh web. A local add . link needs pnpm build and a restart instead.',
